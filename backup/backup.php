...
function backup_database($host, $user, $pass, $dbname, $backupDate) {
    ...
    $filePath = "C:/backup/warehouse_management_cenpri/db_backup/$backupDate.sql";
    ...
    $oneDrivePath = "C:/Users/MMS KIOSK/OneDrive/warehouse_management/db_backup/$backupDate.sql";
...
$ImagesBackup = [
    'C:/Systems/warehouse_management_cenpri/public/images',
];
$imagesZipPath = "C:/backup/warehouse_management_cenpri/uploads/images/$backupDate.zip";
zip_directories($ImagesBackup, $imagesZipPath);
rcopy($imagesZipPath, "C:/Users/MMS KIOSK/OneDrive/warehouse_management/uploads/images/$backupDate.zip");

// 3. Gatepass Items Folder Backup
$GatepassItemsBackup = [
    'C:/Systems/warehouse_management_cenpri/public/gatepass_items'
];
$gatepassZipPath = "C:/backup/warehouse_management_cenpri/uploads/gatepass/$backupDate.zip";
zip_directories($GatepassItemsBackup, $gatepassZipPath);
rcopy($gatepassZipPath, "C:/Users/MMS KIOSK/OneDrive/warehouse_management/uploads/gatepass/$backupDate.zip");
