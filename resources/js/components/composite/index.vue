				...
				<div class="card mb-3">	
					<div class="flex justify-between content-center">
						<div class="flex justify-start space-x-3 ">
							...
							<div>
								<h6 class="m-0 pt-1 font-bold uppercase">Composite Items List</h6>
							</div>
						</div>	
						<div class="pt-1">	
						...
						<div class="card">
							<div class="table-responsive-md pt-3">
								<div class="flex justify-between pb-2 mt-0 mb-2 s z-50 ">
									<a href="/item_list/composite/new" class="btn btn-sm btn-primary btn-rounded pull-left">
								...
								<table id="main_table" class="display text-sm" width="100%">  
									<thead>
										<tr>
											<th scope="col" width="15%" class="text-sm !text-gray-600">Part No</th>
