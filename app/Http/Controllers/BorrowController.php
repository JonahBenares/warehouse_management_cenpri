...
class BorrowController extends Controller
{
    ...
    public function get_all_borrowed(Request $request){
        ...
        // })->paginate(10);
        })->where('saved','=','1')->orderBy('borrow_date','DESC')->paginate(10);
    ...
    public function create_borrow_head(){
        ...
        $mbr_no = 'MBR-'.$max_value.'-'.$curr_mo.'-'.$curr_year;
    ...
    public function save_borrow(Request $request){
        ...
        foreach(json_decode($item_list) as $il){
            ...
            $mreqf_no_by = 'MREQF-'.$max_value_by.'-'.$curr_mo.'-'.$curr_year;
            ...
            $mreqf_no_from = 'MREQF-'.$max_value_from.'-'.$curr_mo.'-'.$curr_year;
